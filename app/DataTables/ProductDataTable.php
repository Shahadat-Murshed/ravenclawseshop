    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $editBtn = "<a href='".route('admin.products.edit', $query->id)."' class='btn btn-primary ml-2'><i class='far fa-edit'></i></a>";
                ...
                $showBtn = "<a href='".route('admin.products.show', $query->id)."' class='btn btn-success'><i class='far fa-eye'></i></a>";

                return $showBtn.$editBtn.$deleteBtn;
            })
            ->addColumn('icon', function($query){
                return "<img width='70px' src='".asset($query->icon)."' ></img>";
            })
            ...
            ->rawColumns(['icon', 'thumbnail', 'category', 'status', 'action'])
            ->setRowId('id');
    }
