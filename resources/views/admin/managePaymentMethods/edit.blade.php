        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Update {{$user ?? 'Payment'}} method</div>
            </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Editing {{$method->number }} {{$user ?? 'Payment'}} Number</h4>
                </div>
                <div class="card-body">
                  <form action="{{route('admin.paymentmethods.update', $method->id)}}" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input id="number" type="text" class="form-control" name="number" value="{{$method->number}}">
